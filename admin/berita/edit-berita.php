  ...
  <body class="bg-light">
    ...
    <main class="container my-5">
      <div class="mb-4 d-flex align-items-center gap-3">
        ...
        <div>
          <h2 class="fw-bold text-secondary m-0">Edit Berita</h2>
          <p class="text-muted mb-0">Perbarui data berita yang sudah ada.</p>
        </div>
      </div>
        ...
        <div class="card-body p-4">
          <form>
            <div class="mb-4">
              ...
              <input type="text" class="form-control form-control-lg rounded-3" id="judulBerita" value="Kicau Mania Mendunia">
            </div>
            ...
            <div class="row g-4 mb-4">
              <div class="col-md-6">
                ...
                <select class="form-select form-select-lg rounded-3" id="kategoriBerita">
                  ...
                  <option value="3" selected>Hobi</option>
                </select>
              </div>
              <div class="col-md-6">
            ...
            <div class="mb-4">
              <label for="gambarBerita" class="form-label fw-medium text-dark">Upload Gambar Thumbnail Baru (Opsional)</label>
              <input class="form-control form-control-lg rounded-3" type="file" id="gambarBerita">
              <div class="form-text mt-2 text-muted">Abaikan jika tidak ingin mengubah gambar thumbnail.</div>
            </div>

            <div class="mb-5">
              <label for="isiBerita" class="form-label fw-medium text-dark">Isi Berita</label>
              <textarea class="form-control rounded-3" id="isiBerita" rows="8">Kicau mania mendunia dengan berbagai macam burung unik dari seluruh nusantara yang menarik perhatian.</textarea>
            </div>

            <div class="d-flex gap-2">
              <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 fw-medium d-flex align-items-center gap-2">
                <iconify-icon icon="mdi:content-save" width="20" height="20"></iconify-icon> Perbarui Berita
              </button>
